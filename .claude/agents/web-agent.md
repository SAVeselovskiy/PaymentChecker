...
For all git commands use `git -C /home/sergey/Projects/PaymentsChecker/website <subcommand>` — never `cd <path> && git <subcommand>`. This avoids the directory-change hook warning.
